...
AutoLayout.prototype._layoutElements = function(group, parentDi) {
  ...
  elements.forEach(function(element) {
    ...
    if (element.flowElements && element.$type === 'bpmn:SubProcess') {
      ...
      let offsetX = (element.bounds.x + element.bounds.width / 2) - (bounds.x + bounds.width / 2)
      let offsetY = (element.bounds.y + element.bounds.height / 2) - (bounds.y + bounds.height / 2)
      element.offsets = {
        x: offsetX + offsets.x,
        y: offsetY
      }
